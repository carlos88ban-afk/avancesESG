...
function buildEmailPlainText(unit, pendingRows) {
  ...
  return [
    ...
    '',
    'Se ha identificado que existen proveedores pendientes de completar la encuesta ESG. Su seguimiento es importante para asegurar el avance oportuno del proceso y mantener la información de cumplimiento actualizada.',
    '',
    'A continuación, se detallan los proveedores que requieren accion:',
    '',
...
export default function Progress() {
  ...
  const handleExportExcel = async () => {
    ...
    try {
      await downloadExcelReport(exportRows, rows, lastStatusDate, currentStatusDate);
